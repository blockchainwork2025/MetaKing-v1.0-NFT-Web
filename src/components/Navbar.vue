  ...
  <main class="navbar">
    <section class="navbar-brand">
      ...
      <div class="flex items-center gap-3">
        ...
        <h1 class="text-indigo-300 text-xl font-semibold lg:text-3xl">MetaKing v1.0</h1>
      </div>
      <!-- Toggle -->
    ...
    <section :class="showMenu ? 'right-0' : '-right-full'" class="navbar-menu">
      ...
      <section class="w-3/12 hidden md:block text-slate-600 rounded-lg">
        <div class="flex justify-between">
          <template v-for="item in socials" :key="item.name">
            <a class="block flex text-gray-200" :href="item.url" target="_blank">
...
const socials = [
  {
    name: 'telegram',
    url: 'https://t.me/blockking99'
  },
  {
    name: 'twitter',
    url: 'https://x.com/Blockchain55355'
  },
  {
    name: 'discord',
    url: 'https://discord.gg/NMGr9KVm'
  },
  {
    name: 'Github',
    url: 'hhttps://github.com/blockchainwork2025'
  }
]
</script>
